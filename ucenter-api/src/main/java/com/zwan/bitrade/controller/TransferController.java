...
import com.zwan.bitrade.util.DESUtil;
...
public class TransferController {
    ...
    public MessageResult transferAddress(String unit, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) {
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult transfer(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user, String unit, String address,
        ...
        MemberWallet memberWallet = memberWalletService.findByCoinAndMemberId(coin, user.getId());
        isTrue(BigDecimalUtils.compare(memberWallet.getBalance(), BigDecimalUtils.add(amount, fee)), sourceService.getMessage("INSUFFICIENT_BALANCE"));
    ...
    public MessageResult pageWithdraw(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user, int pageNo, int pageSize) {
