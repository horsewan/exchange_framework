...
import com.zwan.bitrade.util.GoogleAuthenticatorUtil;
...
public class GoogleAuthenticationController extends BaseController{
    ...
    public MessageResult yzgoogle(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user, String codes) {
    ...
    public MessageResult  sendgoogle(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) {
        /*for(int i = 0;i<50;i++){
            log.info("######################       开始循环次数={}    ######################",i+1);
    ...
    public MessageResult jcgoogle(String codes, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user, String password) {
        // enter the code shown on device. Edit this and run it fast before the
        // code expires!
        ...
        public MessageResult googleAuth(String codes, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user, String secret) {
