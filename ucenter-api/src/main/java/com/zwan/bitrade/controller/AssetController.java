...
import com.zwan.bitrade.service.MemberTransactionService;
...
import com.zwan.bitrade.system.CoinExchangeFactory;
...
public class AssetController {
    ...
    public MessageResult findWallet(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember member) {
    ...
    public MessageResult findTransaction(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember member, int pageNo, int pageSize, TransactionType type) {
    ...
    public MessageResult findTransaction(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember member, HttpServletRequest request, int pageNo, int pageSize,
    ...
    public MessageResult findWalletBySymbol(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember member, @PathVariable String symbol) {
        MessageResult mr = MessageResult.success("success");
    ...
    public MessageResult transformCheck(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember member) throws Exception {
        String symbol = "GCX";
    ...
    public MessageResult transform(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember member, BigDecimal amount) throws Exception {
        String symbol = "GCX";
    ...
    public MessageResult resetWalletAddress(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember member, String unit) {
        try {
