...
import com.zwan.bitrade.entity.LoginInfo;
...
public class LoginController extends BaseController {
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult loginOut(HttpServletRequest request, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) {
