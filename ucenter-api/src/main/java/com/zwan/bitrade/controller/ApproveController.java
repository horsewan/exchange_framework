...
public class ApproveController {
    ...
    public MessageResult update(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user, String url) {
    ...
    public MessageResult securitySetting(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) {
        Member member = memberService.findOne(user.getId());
        ...
        MemberSecurity memberSecurity = MemberSecurity.builder().username(member.getUsername())
                ...
                .fundsVerified(StringUtils.isEmpty(member.getJyPassword()) ? BooleanEnum.IS_FALSE : BooleanEnum.IS_TRUE)
                .loginVerified(BooleanEnum.IS_TRUE)
                ...
                .realAuditing(member.getRealNameStatus().equals(RealNameStatus.AUDITING) ? BooleanEnum.IS_TRUE : BooleanEnum.IS_FALSE)
                .avatar(member.getAvatar())
                .accountVerified((member.getBankInfo() == null && member.getAlipay() == null && member.getWechatPay() == null) ? BooleanEnum.IS_FALSE : BooleanEnum.IS_TRUE)
                .googleStatus(member.getGoogleState())
                .build();
        if (memberSecurity.getRealAuditing().equals(BooleanEnum.IS_FALSE) && memberSecurity.getRealVerified().equals(BooleanEnum.IS_FALSE)) {
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult approveTransaction(String jyPassword, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) throws Exception {
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult updateTransaction(String oldPassword, String newPassword, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) throws Exception {
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult resetTransaction(String newPassword, String code, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) throws Exception {
        hasText(newPassword, msService.getMessage("MISSING_NEW_JY_PASSWORD"));
        isTrue(newPassword.length() >= 6 && newPassword.length() <= 20, msService.getMessage("JY_PASSWORD_LENGTH_ILLEGAL"));
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult bindPhone(HttpServletRequest request, String password, String phone, String code, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) throws Exception {
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult updateLoginPassword(HttpServletRequest request, String oldPassword, String newPassword, String code, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) throws Exception {
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult bindEmail(HttpServletRequest request, String password, String code, String email, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) throws Exception {
        hasText(password, msService.getMessage("MISSING_LOGIN_PASSWORD"));
        hasText(code, msService.getMessage("MISSING_VERIFICATION_CODE"));
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult realNameApproveDetail(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) {
        Member member = memberService.findOne(user.getId());
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult accountSetting(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) {
        Member member = memberService.findOne(user.getId());
        ...
        MemberAccount memberAccount = MemberAccount.builder().alipay(member.getAlipay())
                .aliVerified(member.getAlipay() == null ? BooleanEnum.IS_FALSE : BooleanEnum.IS_TRUE)
                .bankInfo(member.getBankInfo())
                .bankVerified(member.getBankInfo() == null ? BooleanEnum.IS_FALSE : BooleanEnum.IS_TRUE)
                .wechatPay(member.getWechatPay())
                .wechatVerified(member.getWechatPay() == null ? BooleanEnum.IS_FALSE : BooleanEnum.IS_TRUE)
                .realName(member.getRealName())
                .build();
        MessageResult result = MessageResult.success();
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult bindBank(@Valid BindBank bindBank, BindingResult bindingResult, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) throws Exception {
        Member member = memberService.findOne(user.getId());
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult updateBank(@Valid BindBank bindBank, BindingResult bindingResult, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) throws Exception {
        return doBank(bindBank, bindingResult, user);
    }
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult bindAli(@Valid BindAli bindAli, BindingResult bindingResult, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) throws Exception {
        Member member = memberService.findOne(user.getId());
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult updateAli(@Valid BindAli bindAli, BindingResult bindingResult, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) throws Exception {
        return doAli(bindAli, bindingResult, user);
    }
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult bindWechat(@Valid BindWechat bindWechat, BindingResult bindingResult, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) throws Exception {
        Member member = memberService.findOne(user.getId());
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult updateWechat(@Valid BindWechat bindWechat, BindingResult bindingResult, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) throws Exception {
        return doWechat(bindWechat, bindingResult, user);
    }
    ...
    public MessageResult certifiedBusinessStatus(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) {
        Member member = memberService.findOne(user.getId());
        ...
        if(businessCancelApplies!=null&&businessCancelApplies.size()>0){
            if(businessCancelApplies.get(0).getStatus()== CertifiedBusinessStatus.RETURN_SUCCESS) {
                if(member.getCertifiedBusinessStatus()!= CertifiedBusinessStatus.VERIFIED) {
                    certifiedBusinessInfo.setCertifiedBusinessStatus(CertifiedBusinessStatus.RETURN_SUCCESS);
                }
            }else if(businessCancelApplies.get(0).getStatus()== CertifiedBusinessStatus.RETURN_FAILED){
                certifiedBusinessInfo.setCertifiedBusinessStatus(CertifiedBusinessStatus.RETURN_FAILED);
            }else{
                certifiedBusinessInfo.setCertifiedBusinessStatus(CertifiedBusinessStatus.CANCEL_AUTH);
            }
        }
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult certifiedBusiness(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user, String json,
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult changePhone(HttpServletRequest request, String password, String phone, String code, @SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user) throws Exception {
        Member member = memberService.findOne(user.getId());
        hasText(password, msService.getMessage("MISSING_LOGIN_PASSWORD"));
        hasText(phone, msService.getMessage("MISSING_PHONE"));
        hasText(code, msService.getMessage("MISSING_VERIFICATION_CODE"));
    ...
    @Transactional(rollbackFor = Exception.class)
    public MessageResult cancelBusiness(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember user,
                                        @RequestParam(value = "detail",defaultValue = "")String detail) {
        log.info("user:{}",user);
        Member member=memberService.findOne(user.getId());
        if(member.getCertifiedBusinessStatus()== CertifiedBusinessStatus.CANCEL_AUTH){
        ...
        member.setCertifiedBusinessStatus(CertifiedBusinessStatus.CANCEL_AUTH);
        ...
        cancelApply.setStatus(CertifiedBusinessStatus.CANCEL_AUTH);
