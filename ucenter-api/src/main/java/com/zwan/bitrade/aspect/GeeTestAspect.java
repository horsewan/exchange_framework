...
import com.zwan.bitrade.exception.GeeTestException;
...
public class GeeTestAspect {
    ...
    @Pointcut("execution(public * com.zwan.bitrade.controller.RegisterController.registerByEmail(..))"+
            "||execution(public * com.zwan.bitrade.controller.SmsController.resetPasswordCode(..))"+
            "||execution(public * com.zwan.bitrade.controller.RegisterController.sendResetPasswordCode(..))")
    public void geeTest() {
    }
    @Pointcut("execution(public * com.zwan.bitrade.controller.SmsController.sendCheckCode(..))")
