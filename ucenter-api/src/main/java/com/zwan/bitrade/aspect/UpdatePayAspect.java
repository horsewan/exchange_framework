...
public class UpdatePayAspect {
    ...
    @Pointcut("execution(public * com.zwan.bitrade.controller.ApproveController.updateAli(..))"+
            "||execution(public * com.zwan.bitrade.controller.ApproveController.updateBank(..))"+
            "||execution(public * com.zwan.bitrade.controller.ApproveController.updateWechat(..))")
